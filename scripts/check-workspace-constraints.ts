...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  // Agent-scoped provider resolution is a separate runtime entry consumed by
  // the root Session Context service and isolated Agent preset providers.
  '@deepseek-ai/dsh-compaction': ['lib/directory.js'],

...
- Multimodal blocks returned with coordinated adapter, UI, and compaction support ([web image input](../feature/2026-07-22-web-multimodal-image-input-and-durable-attachments.md)); [the drop-image Agent Note](../../archived/simplification/2026-07-04-drop-image-content-block.md) records the earlier removal.

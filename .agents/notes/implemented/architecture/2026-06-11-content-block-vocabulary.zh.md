...
- 多模态块已在适配器、UI 和上下文压缩（context compaction）三方协同支持下回归（[Web 图片输入](../feature/2026-07-22-web-multimodal-image-input-and-durable-attachments.md)）；[drop-image Agent Note](../../archived/simplification/2026-07-04-drop-image-content-block.md)记录了此前那次移除。

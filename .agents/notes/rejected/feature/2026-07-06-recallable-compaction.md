...
Status: rejected — superseded by unified Session context generations and backend-independent checkpoint recall
...
This proposal is rejected in favor of the backend-independent provenance and bounded recall in the [implemented Session context-management decision](../../implemented/feature/2026-08-16-session-context-management.md). The rejected design remains active as a guardrail against coupling recall to a second retention algorithm and permanently adding an index-stub directory to every request.

...
This tutorial creates a minimal Harness plugin and loads it into the Web UI. Start from a repository checkout that has completed the [first-launch path](../../../../README.md#1-the-computer).

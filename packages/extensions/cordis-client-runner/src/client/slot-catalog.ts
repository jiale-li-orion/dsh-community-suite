...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, context-rewrite, manual-compaction, model-retry, steering, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      'client-ui-context ContextRewriteNode key \'context-rewrite\'',
  ...
  {
    key: 'conversation.context-meter.action',
    kind: 'single',
    scope: 'session',
    summary: 'Optional action row at the bottom of the Context occupancy popover.',
    doc: 'Optional action row at the bottom of the Context occupancy popover.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-context ContextMeterAction',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench createUploadEntry(upload) id \'workbench-upload\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench WorkbenchToggle id \'workbench-toggle\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-context ContextView id \'context\'',
  ...
  {
    key: 'shell.mobile.bar',
    kind: 'list',
    scope: 'root',
    summary: 'The narrow frame\'s page bar: the additive seat for the actions that own a page.',
    doc: 'The narrow frame\'s page bar: the additive seat for the actions that own a\npage. A fresh `id` is added beside the shipped entries.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench WorkbenchBarAction id \'workbench-toggle\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.mobile.bar\', () => ctx.slots.register(\n      { name: \'shell.mobile.bar\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-connection-status ConnectionBanner id \'connection-status\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench WorkbenchShell',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workbench UploadsPanel id \'uploads\'',
      'client-ui-workbench ThemePanel id \'theme\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'workbench\' (client-ui-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench MarkdownViewer',
      'client-ui-workbench CodeViewer',
      'client-ui-workbench PdfViewer',
      'client-ui-workbench TextViewer',

...
import { registerTrajectoryContextManagementDefinition } from './trajectory-context-management-definition.ts'
...
export function apply(ctx: Context): void {
  ...
  registerTrajectoryContextManagementDefinition(ctx)

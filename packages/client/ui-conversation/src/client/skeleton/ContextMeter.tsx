...
export interface ContextMeterProps {
  ...
  /** Render the optional feature-owned action with a popover close callback. */
  renderAction?: (close: () => void) => ReactNode
}

export function ContextMeter({ useProjection, t, renderAction = () => null }: ContextMeterProps) {

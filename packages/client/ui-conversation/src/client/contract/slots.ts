...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Optional action row at the bottom of the Context occupancy popover. */
    'conversation.context-meter.action': { kind: 'single'; scope: 'session'; owner: ContextMeterActionOwnerProps }
    /**
...
/** Owner currency for an optional Context occupancy popover action. */
export interface ContextMeterActionOwnerProps {
  /** Close the popover after the action changes the active conversation view. */
  close: () => void
}
...
export type ComposerBarProps =
  ...
  & PropsRenderSlots<'conversation.input.plan' | 'conversation.input.model' | 'conversation.context-meter.action'>

 ...
 * sequence-ordered Event projection and materializes registered view snapshots.
 */
export class ConversationNodeAssembler implements ConversationViewSnapshotStore {
   ...
   * @param entries - complete sequence-ordered history projection.
  ...
  /**
   * Add one contiguous committed live-tail event without scanning existing Contexts.

...
export interface TokenMeasurementTotals {
...
export interface TokenMeasurement extends TokenMeasurementTotals {
...
export interface TokenRangeMeasurement extends TokenMeasurementTotals {

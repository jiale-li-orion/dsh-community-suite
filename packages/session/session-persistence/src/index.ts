...
import type { SessionEvent, SessionId, SessionHeader, SessionLogCut } from '@deepseek-ai/dsh-session'
...
export abstract class SessionPersistence extends Service {
  ...
  async prepare(id: SessionId, signal?: AbortSignal): Promise<SessionPreparation> {
    ...
    return SessionPreparation.create(sessions.prepare(id, {
      seed: Array.from(loaded.log.values(), event => structuredClone(event)),

...
export class LocalSubprocessRuntime extends SubprocessRuntime {
  ...
  /** Shared production inspector so concurrent terminal polls can reuse one bounded process snapshot. */
  private defaultTerminalInspector: ProcessInspector | undefined
  ...
  async spawnTerminal(spec: SubprocessTerminalSpawnSpec): Promise<SubprocessTerminalHandle> {
    ...
    const inspector = this.terminalInspector ?? (this.defaultTerminalInspector ??= createProcessInspector())

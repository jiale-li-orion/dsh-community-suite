...
/** Incremental sandbox override fold for one Session object. */
...
export class SandboxPolicyService extends Service {
  ...
  private readonly fold = new SessionEventFold<SandboxSessionState>(
    () => ({ mode: undefined }),
    (state, event) => {
  ...
  overrideOf(session: Session): SandboxMode | undefined {
    return this.fold.read(session).mode
  }
}

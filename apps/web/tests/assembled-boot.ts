...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-context', bundlePath: 'packages/client/ui-context/lib/client.js', url: '/plugins/ui-context.js', rev: 'fx', inject: ['@deepseek-ai/dsh-api-remotes', '@deepseek-ai/dsh-client-locale', '@deepseek-ai/dsh-client-runtime', '@deepseek-ai/dsh-client-ui-conversation'] },

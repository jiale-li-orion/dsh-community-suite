...
flowchart LR
  ...
  plugin_dsh_base_compaction_directory["compaction-directory<br/>@deepseek-ai/dsh-compaction/directory"]
  cfg --> plugin_dsh_base_compaction_directory
  plugin_dsh_base_session_context["session-context<br/>@deepseek-ai/dsh-session-context"]
  cfg --> plugin_dsh_base_session_context
  ...
  plugin_dsh_base_tool_session_context["tool-session-context<br/>@deepseek-ai/dsh-tool-session-context"]
  cfg --> plugin_dsh_base_tool_session_context
...
| `compaction-directory` | `@deepseek-ai/dsh-compaction/directory` |
| `session-context` | `@deepseek-ai/dsh-session-context` |
| `compaction-basic` | `@deepseek-ai/dsh-compaction-basic` |
| `command-compact` | `@deepseek-ai/dsh-command-compact` |
| `tool-session-context` | `@deepseek-ai/dsh-tool-session-context` |
